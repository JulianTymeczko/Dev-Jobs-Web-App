...
export default function Nav() {
   const[placeholder, setPlaceholder] = useState(firstTime())
    ...
    return (
        <>
            <div className="search-bar"><img src="/assets/desktop/icon-search.svg" alt="" /><input type="text" id="search-bar-input" placeholder={placeholder}/><div id="mobile-icons"><img src="/assets/mobile/icon-filter.svg" alt="" /><a href="#" className="padded-anchor"><img src="/assets/desktop/white-icon-search.svg" alt="" /></a></div></div>
